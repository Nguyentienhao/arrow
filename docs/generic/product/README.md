...
// HCons(head=Tuple2(a=balance, b=1000), tail=HCons(head=Tuple2(a=available, b=900), tail=arrow.generic.HNil@3b307f1c))
```
...
// DeferredK(deferred=LazyDeferredCoroutine{New}@48942c2a)
```
